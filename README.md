...
- [Qualflare](https://qualflare.com) - Test management with AI failure analysis, flaky-test detection and release-risk scoring, ingesting results from 23 frameworks.
