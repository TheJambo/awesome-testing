...
- [Invariant](https://github.com/yavonalabs/invariant) - Open-source CLI engine to test payment webhook idempotency, background queue race conditions, and database state post-conditions in under 10s.
