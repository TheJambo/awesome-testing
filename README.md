...
- [dsh-verify](https://github.com/263311487-ux/dsh-verify) - The quality gate for agent-built web apps: write JSON acceptance specs, a real browser executes them and returns PASS/FAIL with screenshot receipts.
