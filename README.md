...
- [greencheck](https://github.com/simin-yuan/greencheck) - Zero-dependency Python CLI that mutates a gate's inputs to find validators which accept what they should reject, and flags metrics whose value never varies.
