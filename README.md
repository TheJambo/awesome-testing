...
- [Testorim](https://testorim.com) - AI QA tool for web apps. Describe a test in plain English and an AI agent plans the steps and runs them in a real browser; each run ends with a pass, fail or needs-review verdict, a video, a Playwright trace and a written report. Saved runs replay from CI or on a schedule, and export to Playwright.
