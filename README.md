...
- [inboxsink](https://inboxsink.com/docs) - Disposable inbox API for end-to-end tests: a wait endpoint blocks until the email arrives and returns the OTP code or confirmation link already extracted. Free tier available.
