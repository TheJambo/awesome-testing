...
- [Crilio](https://github.com/mukundzha/crilio) - Open-source CLI tool for LLM regression testing that uses an LLM-as-a-Judge to grade AI outputs and block prompt regressions in CI/CD.
